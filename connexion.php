...
?>
<div class="all0">
<div id="form" class="grid-1"><?php include_Once 'files/inc/form_insc.inc.php'; ?></div>
...
?><hr></div>
<div id="form2" class="grid-1"><?php include_Once 'files/inc/form_connex.inc.php'; ?><br/><br/><?php
if (!empty($errco)) {
    echo $errco;
}
?></div></div>
